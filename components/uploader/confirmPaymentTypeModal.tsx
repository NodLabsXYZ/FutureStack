...
export default function ConfirmPaymentTypeModal(props: ConfirmPaymentTypeModalProps) {
        ...
        return (
            <>
                <div>
                    ...
                    <button
                        type="button"
                        onClick={() => setIsPaymentTypeChosen(true)}
    ...
    return (
        <Transition.Root show={props.open} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" initialFocus={cancelButtonRef} onClose={handleCancel}>
